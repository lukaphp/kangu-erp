package it.computerproject.it.kangu.erp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("KanguErp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("KanguErp");
        ...
        config.getMapConfigs().put("it.computerproject.it.kangu.erp.domain.*", initializeDomainMapConfig(jHipsterProperties));
